...
results.T10C  = load('batteryParameterEstimation_results_3RC_5degC.mat');
...
Battery(idx).Temperature_LUT = [5 10 20 40 ] + 273.15;

%% Em Branch Properties (OCV, Capacity)

% Battery capacity
Battery(idx).Capacity_LUT = [ 4 4 4 4]; %Ampere*hours
...
% R4 Resistance vs SOC rows and T columns
Battery(idx).R4_LUT = [ results.T5C.R4 ...
                        results.T10C.R4 ...
                        results.T20C.R4 ...
                        results.T40C.R4]; %Ohms
...
% C4 Capacitance vs SOC rows and T columns
Battery(idx).t4_LUT = [ results.T5C.tau4 ...
                        results.T10C.tau4 ...
                        results.T20C.tau4 ...
                        results.T40C.tau4]; %Farads
...
Battery(4).SOC0 = 0.26;%Ampere*hours
